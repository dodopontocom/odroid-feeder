...
ShellBot.InlineKeyboardButton --button 'botao2' --line 1 --text '${dias[0]}' --callback_data 'btn_ter'
ShellBot.InlineKeyboardButton --button 'botao2' --line 1 --text '${dias[0]}' --callback_data 'btn_qua'
ShellBot.InlineKeyboardButton --button 'botao2' --line 1 --text '${dias[0]}' --callback_data 'btn_qui'
ShellBot.InlineKeyboardButton --button 'botao2' --line 1 --text '${dias[0]}' --callback_data 'btn_sex'
ShellBot.InlineKeyboardButton --button 'botao2' --line 1 --text '${dias[0]}' --callback_data 'btn_sab'
ShellBot.InlineKeyboardButton --button 'botao2' --line 1 --text '${dias[0]}' --callback_data 'btn_dom'
